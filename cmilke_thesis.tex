...
% Ch1: Introduction - DRAFT 1
\input{src/introduction.tex}

% Ch2: Standard Model Discussion - DRAFT 1
...
% Ch6: Reconstruction - DRAFT 1
\input{src/reconstruction.tex}

% Ch7: Selection - DRAFT 1
\input{src/selection.tex}

% Ch8: Background Estimation - DRAFT 1
\input{src/background.tex}

% Ch9: Signal Modeling - DRAFT 1
\input{src/signal_model.tex}

% Ch10: Results - DRAFT 0
\input{src/results.tex} % TODO
...
%    \input{src/appendix_A.tex} %TODO ALTIROC will probably go here
...
/widthf=ldt\''O\begin{subfigure}{pa\textwidth}€ýajddp>>$%i\end{subfigure''cf[\captionsetup{justification=centering} \caption{A€kb€kb}€ýa/subfloat
