...
% Ch6: Reconstruction and Selection %TODO
\input{src/event_reco_select.tex}

% Ch7: Background Estimation %TODO
\input{src/background_est.tex}

% Ch8: Signal Modeling / Monte-Carlo techniques / My combination technique :D %TODO
\input{src/signal_model.tex}

% Ch9: Results (pyhf, findings, uncertainties, statistics...) %TODO
\input{src/results.tex}

% Ch10: Conclusion and Future Studies %TODO
%       work on ALTIROC?
