...
\input{src/atlas.tex}
  ...
  jand the ATLAS (Start here)


 % Ch4 1/2: maybe a discussion of ATLAS software (Athena, ROOT, etc)? 

 % Ch5: Search (what am I looking for, how did I go about it, etc)

 % Ch6: Results (findings, uncertainties, statistics...)

 % Ch7: Conclusion and Future Studies
