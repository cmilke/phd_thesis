...
% Ch8: Background Estimation - OUTLINE
\input{src/background.tex} %TODO

% Ch8: Signal Modeling - DRAFT BETA
\input{src/signal_model.tex} %TODO

% Ch9: Results (pyhf, findings, uncertainties, statistics...) - OUTLINE
\input{src/results.tex}

% Ch10: Conclusion and Future Studies - BRAINSTORM
%       work on ALTIROC?
