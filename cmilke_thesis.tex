...
\begin{thesis}
 ...
 % Ch3: LHC and the ATLAS (Start here)
 \input{src/experiment.tex}


 % Ch3 1/2: maybe a discussion of ATLAS software (Athena, ROOT, etc)? 

 % Ch4: Search (what am I looking for, how did I go about it, etc)

 % Ch5: Results (findings, uncertainties, statistics...)

 % Ch6: Conclusion and Future Studies
