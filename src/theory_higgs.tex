\section{Origin of Mass: The Higgs Mechanism}\label{sec:higgs_mechanism}
    ...
    This is a small, seemingly innocuous change, so allow me to emphasize:
        this quartic potential is the lynchpin of the entire Standard Model,
...
\section{Breaking Symmetry: GWS Theory}
    ...
    Returning finally to Equation \ref{eq:lagv}, I now have
    \begin{equation} \begin{split}
        \label{eq:lagv_full}
...
\section{Keystone of the Standard Model: The Higgs Boson}
    ...
    In 2012, the Higgs Boson was detected with a mass of 125 GeV, solidifying both its existance and crucial role in the Standard Model.
    More to the point, its detection confirmed the existance of at least the Higgs kinetic energy term in the Lagrangian.
    ...
    Any value other than 1 would indicate deviation from the Standard Model, which would need to be explained with a modification to (or entirely new) theory.
