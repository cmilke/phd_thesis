\section{Breaking Symmetry: The Higgs Mechanism}\label{sec:higgs_mechanism}
    ...
    The W and Z fields have mass.
    A gauge field \textit{cannot} have mass.
    A brief check will confirm that a lagrangian mass term of the form $\Lag$ %TODO
        will violate gauge symmetry.
    ...
    Also I need to introduce the Klein-Gordon Equation
...
\section{Keystone of the Standard Model: Electro-Weak Symmetry Breaking}
    ...
    Returning now to Equation \ref{eq:lagv}, we have
    \begin{equation} \begin{split}
        \label{eq:lagv_full}
