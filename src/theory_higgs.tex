\section{Breaking Symmetry: The Higgs Mechanism}\label{sec:higgs_mechanism}

    The derivation provided through the next three sections seeks to explain
    ...
    The first step is to indroduce a single massless, scalar field $\phi$.
    ...
    In the next section, I will show how the scalar field can induce mass in fields other than itself.
...
\section{Keystone of the Standard Model: Electro-Weak Symmetry Breaking}
    ...
    Once again, I allow the scalar field to fall into its offset minimum $v \equiv \frac{\mu}{\sqrt{\lambda}}$, as $\phi(x) \rightarrow h(x) + v$.
    ...
    Returning now to Equation \ref{eq:lagv}, I have
    \begin{equation} \begin{split}
        \label{eq:lagv_full}
