...
\section{Keystone of the Standard Model: The Higgs Boson} \label{sec:higgs_boson}
    ...
    \begin{equation} \begin{split}
        \Lag_K &= \frac{1}{2} |D_{\mu} \vec{\phi}|^2
            ...
            \\&= \frac{1}{2} | \partial_{\mu}h |^2
                ...
                + \frac{1}{2} \left(\frac{1}{2}\sqrt{g^2 + g^{\prime 2}}\right)^2\ (Z^0_{\mu})^2 \right] (h+v)^2
            \\&= \frac{1}{2} | \partial_{\mu}h |^2
    ...
    \begin{equation} \begin{split}
        \Lag_K = \frac{1}{2} | \partial_{\mu}h |^2 + \Lag_v
            ...
            + \left[ m_W^2 W^{-\ \mu} W^+_{\mu} + \frac{m_Z^2}{2} (Z^0_{\mu})^2 \right] h^2
        \,.
    \end{split} \end{equation}
    ...
    For example, $\kappa_V \equiv \frac{g'_V}{g_V} = \frac{g'_V}{m_h m_V^2 \sqrt{2/\lambda}}$.
