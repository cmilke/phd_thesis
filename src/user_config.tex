...
\ThesisTitle{Improved Constraints on the Standard Model}
    {Higgs Self-Interaction Using a Search for \hhbbbb}
    {via the Vector-Boson Fusion Production Mode}
...
\CommitteeMemberTitleA{Associate Professor}

\CommitteeMemberB{Dr.~Jingbo Ye}
\CommitteeMemberTitleB{Professor}
