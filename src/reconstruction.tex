\chapter{Event Reconstruction}
    ...
    \section{Tracks} \label{sec:reco_tracks}
        ...
        \subsection{Track Reconstruction}
            ...
            %Clusterization
            The first step in reconstructing a track is to figure out where the dots to connect actually are, 
    ...
    \section{Jets}
        ...
        All these new particles will produce similar reactions, until the various particles posses too little energy to scatter any more.
        ...
        \antikt has a single input parameter, $\Delta R$, which roughly corresponds to the ``radius''
            of the jets in the calorimeters that \antikt should attempt to match to.
        %what is delta R
        This radius is described as a solid angle (in $\phi$ and $\eta$) distance from the center of the topo-cluster,
            such that $\Delta R^2 \equiv \Delta \eta^2 + \Delta \phi^2$.
        A $\Delta R$ value of 0.4 is the standard for jets, and what is used for this analysis.
    ...
    \section{Flavour Tagging}
        ...
        \subsection{Impact Parameter Taggers}
            ...
            The low-level b-tagging algorithms come in the two forms of impact parameter taggers and secondary vertexing algorithms.
            ...
            [explain the sign convention. TODO]
            ...
            %TODO - pic: I might want a plot explaining this. kinda like giacinto's figure 6.3, but ideally less confusing
            ...
            These distributions are then used as a discriminant to distinguish b-jets and charm-jets from light-jets
                (see Figure TODO)\cite{thesis_giacinto}. %TODO: is there a non-empiricle, like, physics reason for this?
    ...
    \section{Online VS Offline Reconstruction}
        ...
        With the degradation in track quality in the online environment, the low level taggers' PDFs are altered.
        And, since the low-level taggers are affected, the high-level taggers are then also affected.
        To account for this, the flavour tagging algorithms undergo a \textit{retuning} procedure from offline to online,
            which adjust how the algorithms expect tracks to look.
        ...
        First, the HLT-tuned Athena framework is run on a large sample of simulation-based data,
            which emulates the reconstruction behaviour of Athena in the online environment.
        ...
        For MV2, this is ROOT's thing, and for DL1 this is the python package Keras.
        %Step3.2 - Convert training output to useable histograms;
        Once training is complete, the output machine-learning structure is converted into a form usuable by Athena,
