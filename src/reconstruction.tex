    ...
    \section{Tracks} \label{sec:reco_tracks}
        ...
        \subsection{Track Definition}
            ...
            the track's helical shape can reveal all components except for the energy $E$,
                which will eventually be handled by the calorimeters.
            ...
            The five parameters governing the shape of this helix,
                called \textit{perigee parameters} (see Figure \ref{fig:perigee_params}),
        ...
        \subsection{Track Reconstruction}
            ...
            \begin{figure}[tbh]
                ...
                \caption{
                    ...
                    [FIXME: Steve how do I cite an indico presentation? Also is this even a good image to use?].
                }
                \label{fig:track_fit}
            \end{figure}
