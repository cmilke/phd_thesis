\chapter{Event Reconstruction} \label{chapter:reconstruction}
    ...
    \section{Tracks} \label{sec:reco_tracks}
        ...
        \subsection{Track Reconstruction}
            ...
            Further purity is ensured by forming track seeds first only from the SCT, then only from the pixel detector,
                and only afterwards allowing mixed-detector seeds from the remaining space-points.
    ...
    \section{Flavor Tagging}
        ...
        Distinguishing b-jets from other jet types
            (notably, the light-jets produced from the VBF initial-scatter quarks),
        ...
        \subsection{Impact Parameter Taggers}
            ...
            The IPxD taggers effectively treat all tracks in a jet as independent of each other,
                combining their impact parameter information through a mere product of their LLR values.
            RNNIP, a recurrent neural network (see Section \ref{sec:ml_techniques}), expands upon their functionality by correlating
            ...
            \input{tables/reconstruction/rnnip.tex}


        \FloatBarrier
        \subsection{Secondary Vertexing Algorithms}

            Hadronic matter decays in multiple steps,
                producing a series of decay vertices from which more particles (and in turn tracks) are emitted.
            ...
            In ATLAS, there are two primary algorithms that use secondary vertexing to perform b-tagging.
            The first of the ATLAS secondary vertex algorithms, JetFitter, seeks to reconstruct the full multi-vertex structure of the hadronic decay.
    ...
    \section{Online vs Offline Reconstruction}
        ...
        As discussed in Section \ref{sec:reco_tracks}, track reconstruction is very computationally intensive.
        ...
        \begin{figure}[tbh]
            ...
            \caption{
                ...
                Note that the online performance (with its lower quality tracks) is able to perform within $\approx 20\%$
