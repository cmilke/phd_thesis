\chapter{Event Reconstruction} \label{chapter:reconstruction}
    ...
    \section{Jets}
        ...
        Moving outwards from the inner tracker into the calorimeters,
            focus shifts from tracks to the reconstructed objects known as \textit{jets}.
    ...
    \section{Flavor Tagging}
        ...
        TODO: insert table of branching fraction of higgs in theory chapter, reference here
