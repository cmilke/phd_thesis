    ...
    \section{Tracks} \label{sec:reco_tracks}
        ...
        \subsection{Track Definition}
            ...
            Prior to encountering the ATLAS calorimeters,
                particles exiting the IR pass through primarily low-density material (see figure \ref{fig:cal_rad_length}).
            ...
            %FIXME: you used 'r' in the figures, but rho in the equations. Fix one of them
            ...
            \begin{figure}[tbh]
                ...
                \caption{
                    Diagram of space-points formed in the ATLAS Pixel (Red) and SCT (Blue) subdetectors,
                        with track seeds highlighted in yellow
    ...
    \section{Flavor Tagging}
        ...
        \subsection{Impact Parameter Taggers}
            ...
            These distributions are subsequently used as a discriminant to distinguish b-jets and charm-jets from light-jets
                (see Fig. \ref{fig:ip3dsig})\cite{thesis_giacinto}. %TODO: is there a non-empirical, like, physics reason for this?
        ...
        \subsection{High Level Taggers and Machine Learning Techniques}\label{sec:ml_techniques}
            ...
            \begin{figure}
                \subfloat[Flavor Tagging Performance Against Light Jets]{
                    \includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{reconstruction/dl1_performance_ljet}
                }
                \subfloat[Flavor Tagging Performance Against Charm Jets]{
                    \includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio]{reconstruction/dl1_performance_cjet}
                }
                \caption{
