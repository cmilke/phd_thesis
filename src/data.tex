...
\FloatBarrier
    \subsection{High Level Trigger}
        ...
        Why this is expected, and how these selections are optimized,
            comes down to the second kind of data required for the analysis: Monte Carlo simulation data.
...
\section{Monte-Carlo Simulation} \label{sec:mcsim}
    ...
    Finally, the observation through a detector constitutes the last step of event simulation,
        which is handled by Geant4.
    Geant4 seeks to provide a comprehensive simulation of how particles behave as they propagate through physical materials.
