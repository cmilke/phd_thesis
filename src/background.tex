...
\section{Data-Driven Background Estimate}
    ...
    Indeed, based on the relative rates of QCD multijet events and the SM \vbfhhproc (see Table \ref{tab:mcyields})),
    ...
    [TODO: steve, why is it so hard to find anything that actually states what the rough event yield for multijet is?
        ...
        without ever quantifying the statement D:< ]
...
\section{Neural Network Training and Uncertainty} \label{sec:nn_training}
    ...
    \begin{figure}[tbh]
        ...
        \caption{
            ...
            The thin grey lines each correspond to the \mhh histogram of one of the 100 bootstrap networks.
            Each of their bins is expressed here as a ratio of their collective average (the dashed line).
            The standard deviation at each bin is then shown with the red lines,
                which can be seen to do a good job at capturing the overall behaviour
