...
\section{Data-Driven Background Estimate}
    ...
    Indeed, based on the relative rates of QCD multijet events (Fig. \ref{} and the SM \vbfhhproc process (1.18 fb, see Table \ref{tab:mcyields}),
    ...
    \begin{figure}[tbh]
        ...
        \caption{
            ...
            Though the 6-jet events that act as a background in this analysis,
                I should probably just find a better plot... TODO
        }
        \label{fig:lhc_rates}
    \end{figure}
