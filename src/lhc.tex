...
\section{Introduction}
    ...
    %TODO try to back this up with specific details eg a formula from QFT showing how the probability of an interaction depends on energy
...
\section{Accelerator Ring}
    ...
    Due to their high mass, the energy losses protons incur from syncroton radiation are quintically suppressed and thus easily overcome (7 keV losses at the 7 TeV operating point of the LHC \cite{lhc_machine}). % table 4.1
