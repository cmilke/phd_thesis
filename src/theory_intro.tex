\section{Introduction}
    ...
    While its recent discovery has shed light on many of its key properties,
        there are still many details that are as yet uncomfirmed.
...
\section{The Standard Model of Particle Physics}\label{sec:standard_model}
    ...
    In addition to the fermions, there is also an entirely seperate class of spin 1 particles, called gauge bosons,
    ...
    Wherein the second line is written using the natural units, covarient,
    ...
    Describing matter in mathemetical form is the first step in building the Standard Model.
