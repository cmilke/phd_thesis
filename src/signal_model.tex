...
\section{Signal Combination} \label{sec:signal_combination}
    ...
    \begin{equation} \crossterm{1} \qquad \nonumber \end{equation}
    \begin{equation} \crossterm{2} \qquad \nonumber \end{equation}
    \begin{equation} \crossterm{3} \qquad \nonumber \end{equation}
    \begin{equation} \crossterm{4} \qquad \nonumber \end{equation}
    \begin{equation} \crossterm{5} \qquad \nonumber \end{equation}
