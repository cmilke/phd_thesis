\chapter{Signal Modelling} \label{chapter:signal}
...
\section{Signal Combination}
    ...
    The 6-sample combination used in this analysis (Table \ref{tab:vbf_hh_6term_varlist} and Equation \ref{eqn:vbf_hh_6term_chosen}) has been chosen specifically for its ability to avoid mismodelling errors.
