...
\section{Solidarity} \label{sec:solidarity}
    ...
    \begin{figure}[tbh]
        ...
        \subfloat[\kv = 0.5]{
            \includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio,ext=.pdf,type=pdf]{signal/solidarity_performance_kv0.5.pdf}
        }
        \subfloat[\kv = 1.5]{
            \includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio,ext=.pdf,type=pdf]{signal/solidarity_performance_kv1.5.pdf}
        }
        \caption{
