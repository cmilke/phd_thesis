...
\chapter{ATLAS} 
    ...
    It must be located so close to the interaction region in order to permit detection of short lived particles like b-quarks and taus \cite{id_tdr}.
...
\section{Inner Detector} \label{sec:inner_detector}
    ...
    \subsection{Transition Radiation Tracker (TRT)}
        % purpose
            To provide continuous tracking and aid in the identification of electrons via transition radiation \cite{id_tdr}.
        % what kinds of particles will they detect,
