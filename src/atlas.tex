...
\section{Introduction}
    ...
    \begin{figure} \centering
        \includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{atlas/atlas_coords}
        \caption{
...
\section{Inner Detector} \label{sec:inner_detector}
    ...
    \begin{figure}[h] \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{atlas/inner_detector_xsec}
    ...
    \subsection{Pixel Detector and Semiconductor Tracker}
        ...
        \begin{figure} \centering
            \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{atlas/pn_junction}
...
\section{Calorimetry} \label{sec:calorimeter}
    ...
    \begin{figure} \centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{atlas/cal_xsec}
    ...
    \begin{figure} \centering
        \includegraphics[width=\linewidth,height=0.35\textheight,keepaspectratio]{atlas/cal_rad_length}
        \caption{
...
\section{Muon Spectrometer} \label{sec:muon}
    ...
    \begin{figure}\centering
        \includegraphics[width=\linewidth,height=0.4\textheight,keepaspectratio]{atlas/muon_xsec}
    ...
    \subsection{Trigger Chambers}\label{sec:muon-trigger_chamber}
        ...
        The last set of sensors in the ATLAS detector are the Trigger Chambers of the Muon system.
