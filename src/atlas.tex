...
% Readout electronics???
% All the electrical signals from the detectors have to be collected
% need like digital-to-analogue converters and amplifiers and buffers and clock cycles and stuff
% something something and then there are too many signals so you need something to process stuff quick. enter trigger
