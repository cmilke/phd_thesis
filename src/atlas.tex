...
\section{Calorimetry} \label{sec:calorimeter}
    ...
    \subsection{Electromagnetic Calorimeters}
        ...
        Furthermore, the lesser amount of material required for this detector permits higher resolution in it's construction
        ($\eta$ resolution of 0.025 for ECal vs 0.1 for HCal; see table \ref{tab:cal_specs}).
        The closer proximity however comes at the disadvantage of higher radiation flux.
        For this reason, along with it linear ionization response, the active material used in both the ECal Barrel and Endcaps is liquid argon (LAr). \cite{Lar_cal_tdr}.
        Due to its density, lead is then used as the inactive material.
        These liquid argon calorimeters, used in the ECal and elsewhere, detects ionization from incident particles via capacitive coupling to electrodes placed outside the active LAr medium.
        Not only is the ECal of higher resolution in $\eta$, but it uses a unique ``accordian" design in the layout of the material layers, in order to provide complete coverage in $\phi$.
    ...
    \subsection{Hadronic Calorimeter}
        ...
        As mentioned earlier, the more massive, often neutral, nature of these particles require significantly more material to properly contain.
        ...
        Distinct from the LAr-based calorimeters, the HCal Barrel and Extended Barrel must cover a provide coverage to a very large area, making the LAr technology prohibitively costly.
        Reffered to as the Tile Calorimeters, the HCal barrel system instead used scintillating tiles as its active material, with steel plates as the inactive material.
        ...
        The key to scintillating materials is that they respond to ionizaing radiation not by ion release, but by fluorescing.
