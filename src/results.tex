...
\section{Statistical Mathematics}
    ...
    Because this toy experiment has a pvalue larger than 0.05,
    ...
    The pvalue of the signal based on the observed yield is 0.46 [FIXME],
        for a CL of 54\%.
    ...
    Here though, $P_B = 0.31$, which is far from being able to reject the null hypothesis.
...
\section{Final Interpretation}
    ...
    [Hey steve, don't worry about the formatting of any of the plots in this section this edit round.
    ...
    The CL of the SM signal hypothesis with a $\mu$ scale of 1 is only 50\%.
    ...
    However, looking at the \kvv=3 signal model at a $\mu$ scale of 1 provides a CL of $\approx 99\%$,
        which is of far more interest and indicates that a value of \kvv=3 is incompatible with data,
