...
\section{VBF HH 4b Limit-Setting Framework}\label{sec:profile_fit}
    ...
    \begin{figure}
        ...
        \end{subfigure}
        \caption{
            Illustration of data/MC yield and associated errors.
            ``Event Count'' (top) plot displays yields with their statisitical error.
            ``Bgd'' refers to the multi-jet/\ttbar background, ``ggF'' refers to the ggF\to HH process.
            For the ``Yield Error'' plot, the various systematics are shown together added in quadrature.
            The ``Relative Error'' values are relative to their respective yield
                (e.g.\ the signal stat error is shown as a ratio of the signal stat error to the signal yield).
    ...
    \begin{figure}
        \centering
        \begin{subfigure}{0.48\textwidth} 
            \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{results/k2v_scan_VBF_chan_allNP_samps_vbf_pd_vbf_inc161718_kl_1p0_mu}
            \caption{\kvv $\mu$ Scan}
            \label{fig:mulimits_kvv_rooFit}
        \end{subfigure}
        \begin{subfigure}{0.48\textwidth}
            \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{results/kl_scan_VBF_chan_allNP_samps_vbf_pd_vbf_inc161718_k2v_1p0_mu}
            \caption{\kl $\mu$ Scan}
            \label{fig:mulimits_kl_rooFit}
        \end{subfigure}\\
        \begin{subfigure}{0.48\textwidth} 
            \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{results/k2v_scan_VBF_chan_allNP_samps_vbf_pd_vbf_inc161718_kl_1p0_xs}
            \caption{\kvv Cross-section Scan}
            \label{fig:xseclimits_kvv_rooFit}
        \end{subfigure}
        \begin{subfigure}{0.48\textwidth}
            \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{results/kl_scan_VBF_chan_allNP_samps_vbf_pd_vbf_inc161718_k2v_1p0_xs}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{0.48\textwidth}
            \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]
                {results/2D_scan_VBF_chan_allNP_samps_vbf_pd_vbf_inc161718_kl1p0_exclusion}
