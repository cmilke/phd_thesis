\chapter{Event Selection} \label{chapter:selection}
    ...
    \subsection{Jet Multiplicity and Categorization}
        ...
        Central Jets are defined as those within $|\eta| \leq 2.5$, %TODO in 2018 but outdated
            with pt > 40 GeV and which pass JVT or have pt > 60 or have |eta| > 2.4. %TODO in 2018 but outdated
        
        Forward Jets are those with $ 2.5 < |\eta| \leq 4.5 $, in 2018 but outdated
            with pt >= 30 GeV %TODO in 2018 but outdated
    ...
    \subsection{VBF Topology}
        ...
        The selected VBF pair must have a \deta between them of at least 3, %TODO in 2018 but outdated
            and an mjj of at least 1 TeV. %TODO in 2018 but outdated
        As well, the combined vector-sum-pt of all six jets
            (the four Higgs products and the two VBF jets)
            must be less than 65 GeV. %2018 int Figure 13 - all pt is expected to cancel
