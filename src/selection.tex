...
\section{Analysis Cuts} \label{sec:analysis_cuts}
        ...
        \begin{figure}[tbh]
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-kv-5.0}
                \caption{}
            \end{subfigure}
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-kv1.0}
                \caption{}
            \end{subfigure}\\
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-kv5.0}
                \caption{}
            \end{subfigure}
            \caption{
        ...
        \begin{figure}[tbh]
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-kl-15.0}
                \caption{}
            \end{subfigure}
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-kl1.0}
                \caption{}
            \end{subfigure}\\
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-kl21.0}
                \caption{}
            \end{subfigure}
            \caption{
        ...
        \begin{figure}[tbh]
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-k2v-3.0}
                \caption{}
            \end{subfigure}
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-k2v0.0}
                \caption{}
            \end{subfigure}\\
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-k2v1.0}
                \caption{}
            \end{subfigure}
            \begin{subfigure}{0.48\textwidth}
                \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{selection/VBF2D-vbf-MC-Signal-Region-all-4b-accXeff-k2v5.0}
                \caption{}
            \end{subfigure}
            \caption{
    ...
    \subsection{B-Quark Pairing}
        ...
        \begin{figure}[hbt]
            ...
            \subfloat[Pairing accuracy vs \kl]{
                     \includegraphics[width=0.5\textwidth]{selection/pairing_accuracy_kl}
                \label{fig:acc_kl_exists}
            }
            \subfloat[Pairing accuracy vs $\kappa_{2V}$]{
                     \includegraphics[width=0.5\textwidth]{selection/pairing_accuracy_k2v}
