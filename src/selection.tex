...
\section{Introduction}
    ...
    \section{Triggers}
        ...
        \begin{itemize}
            ...
            \item j110: Requires at least one jet with energy greater than 110 GeV
            ...
            \item split: Using ``Split Jets'', which [I can't read what you wrote :/]
            ...
            \item split: (as above)
            \item L1J85: Requires a cluster formed in the Level-1 trigger (recal Section \ref{sec:L1})
                with energy greater than 85 GeV
    ...
    \section{Analysis Cuts} \label{sec:analysis_cuts}
        ...
        MC simulation shows that the ZZ production is highly forward and low-$p_T$,
            ...
            and thus negligeable as a background \cite{vbf_hh_4b_resonant_2020_int}.
    ...
    \subsection{Jet Multiplicity and Categorization}
        ...
        To supress jets from pileup vertices, central jets are only used if they have a $p_T > 40$ GeV,
            and satisfy at least one of the following three conditions:
            they pass the JVT algorithm\footnote{
                The Jet-Vertex-Tagger (JVT) algorithm is a pileup vertix suppression discriminant,
    ...
    \subsection{ Region Definition and \ttbar Removal}
        ...
        The Signal Region (SR) corresponds to those events for which the reconstructed Higgs masses
            ...
            with additional room provided for error in the mass measurment.
        ...
        A quantity $X_{HH}$ governs the boundaries of these regions,
            which effictively acts as a $\chi^2$ fit on the expected Higgs masses,
            and is defined as
        ...
        The \mhh parameters 124 and 117 were chosen to match the center of the \mhh distributions
            of the leading and subleading reconstructed Higgs bosons for
        ...
        To do this, the analyis has turned to a data-driven approach.
